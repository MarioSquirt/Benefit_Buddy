...
source.dir = .
source.include_exts = py,png,jpg,kv,atlas,json,ttf,otf,csv,db,bin,idx
source.include_patterns = app_data/*, app_data/postcodes/*, data/*.csv, font/*.ttf, images/*.png, images/*.jpg, images/*.gif
android.add_src = app_data
version = 1.0.0
